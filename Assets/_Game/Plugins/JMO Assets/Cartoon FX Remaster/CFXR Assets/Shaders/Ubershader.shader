...
Shader "Cartoon FX/Remaster/Particle Ubershader"
{
	...
	//#
		...
		[KeywordEnum(AlphaBlend, Premultiply, Multiply, Additive)] _BlendingType ("Blending Type", Float) = 0
...
/*** BIRP ***/
		...
		SubShader
		{
			...
			Pass
			{
				...
				#define PASS_SHADOW_CASTER
				#define CFXR_UBERSHADER
				#include "Assets/_Game/Plugins/JMO Assets/Cartoon FX Remaster/CFXR Assets/Shaders/CFXR_PASSES.cginc"
